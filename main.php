...
$gtprem2link  = $Get_class->blog_links("article","ar",$gtprem2id,$gtprem2title);
echo"
<a href='$gtprem2link'>
...
$theeprem_posts_link  = $Get_class->blog_links("article","ar",$theeprem_id,$theeprem_title);
